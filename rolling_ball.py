...
class PA:
    ...
    def run(self):
        ...
        #self.prev_vel = self.ball_velocity
        
        #push_strength = np.linalg.norm(fe)
        
        #push = -0.3 * push_strength
        
        
        #self.ball_position_x += direction[0]
        #self.ball_position_y += direction[1]
        
        #prev_acc = ball_acceleration
        
        
        
        #self.x_ball += direction[0] * push
        #self.y_ball += direction[1] * push
        
        #self.ball_position_x += direction[0] * push
        #self.ball_position_y += direction[1] * push
